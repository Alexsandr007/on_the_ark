...
document.addEventListener('DOMContentLoaded', () => {
    const sidebarItems = Array.from(document.querySelectorAll('.advert__sidebar--item'));
    const contentItems = Array.from(document.querySelectorAll('.advert__content--item'));
    ...
    sidebarItems.forEach(item => {
        const img = item.querySelector('.advert__sidebar--item-image img');
        if (!img) return;
