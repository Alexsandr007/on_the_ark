document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateArrows() {
        ...
        // Правая стрелка - активна, если не на последнем слайде (учитываем slidesToShow)
    ...
    function updateSlider(slideIndex = currentSlide, animate = true) {
        ...
        const slideWidth = slidesContainer.offsetWidth / slidesToShow;
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', function() {
            ...
            if (slideIndex !== currentSlide && slideIndex <= totalSlides - slidesToShow) {
    ...
    // Настройка CSS для отображения двух слайдов
    function setupSlidesLayout() {
        ...
        slidesWrapper.style.width = `${slideWidth * totalSlides}px`;
    }
