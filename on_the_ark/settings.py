"""
Django settings for on_the_ark project.
"""
...
MIDDLEWARE = [
    ...
    'user.middleware.UserSessionMiddleware',
]

ROOT_URLCONF = 'on_the_ark.urls'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # ИСПРАВЛЕННАЯ СТРОКА
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
